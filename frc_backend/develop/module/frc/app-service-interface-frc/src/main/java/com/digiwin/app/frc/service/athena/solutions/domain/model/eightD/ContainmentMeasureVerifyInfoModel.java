...
public class ContainmentMeasureVerifyInfoModel {
    ...
    @JsonProperty(value = "containment_measure_verify")
    private List<ContainmentMeasureVerifyModel> containmentMeasureVerifyModels;
