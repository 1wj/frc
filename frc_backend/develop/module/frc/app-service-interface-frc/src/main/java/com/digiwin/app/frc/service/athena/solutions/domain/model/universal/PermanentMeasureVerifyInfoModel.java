...
public class PermanentMeasureVerifyInfoModel {
    ...
    @JsonProperty(value = "lasting_measure_execute_verify")
    private List<PermanentMeasureVerifyModel> permanentMeasureVerifyModels;
